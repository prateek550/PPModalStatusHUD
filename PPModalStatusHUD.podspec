#
#  Be sure to run `pod spec lint PPModalStatusHUD.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Prateek Pande" => "prateek.550@gmail.com" }
  # Or just: s.author    = "Prateek Pande"
  # s.authors            = { "Prateek Pande" => "prateek.550@gmail.com" }
  s.social_media_url   = "http://twitter.com/prateek550"
  ...
  s.source       = { :git => "https://github.com/prateek550/PPModalStatusHUD.git", :tag => "#{s.version}" }
